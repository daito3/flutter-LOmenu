                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                            ...
                            children: [
                              Center(
                                  child: Opacity(
                                    opacity: 0.8,
                                    child: Image.asset(
                                      'assets/lomenu-food/'+ _vegetableImageList[index + 31],
                                    ),
                                  )),
                              Column(
                                children: [
                                          ...
                                          children: [
                                            ...
                                            IconButton(
                                                onPressed: () {
                                                  ...
                                                  setState(() {
                                                    if (_kosu[index + 31] != 99) {
                                                      _kosu[index + 31] = increment(
                                                          _kosu[index + 31]);
                                                    }
                                                    _setPlefItem();
                                                  });
                      ...
                      Expanded(flex: 1,child: Text(_kosu[index + 31].toString())),
                      Expanded(
                          flex: 1,
                          child: Container(
                              child: Container(
