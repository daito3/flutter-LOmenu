...
class Staplefood extends StatefulWidget {
  const Staplefood({Key? key}) : super(key: key);

  @override
  State<Staplefood> createState() => _StaplefoodState();
}
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                            ...
                            children: [
                              Center(
                                  child: Opacity(
                                    opacity: 0.8,
                                    child: Image.asset(
                                      'assets/lomenu-food/'+ _vegetableImageList[index + 55],
                                    ),
                                  )),
                              Column(
                                children: [
                                          ...
                                          children: [
                                            ...
                                            IconButton(
                                                onPressed: () {
                                                  ...
                                                  setState(() {
                                                    if (_kosu[index + 55] != 99) {
                                                      _kosu[index + 55] = increment(
                                                          _kosu[index + 55]);
                                                    }
                                                    _setPlefItem();
                                                  });
                      ...
                      Expanded(flex: 1,child: Text(_kosu[index + 55].toString())),
                      Expanded(
                          flex: 1,
                          child: Container(
                              child: Container(
